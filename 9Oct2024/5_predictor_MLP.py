...
class TrainingUsingMLP:
    ...
    def run(self, pickle_file_name, hidden_layers, max_iter, alpha, learning_rate_init, activation):
        """
...
def train_microsoft():
    mlp_training = TrainingUsingMLP("5_processed_with_actions/MSFT_5day_tech_action.csv", "Microsoft")
    mlp_training.run("5_processed_with_actions/MSFT_5day_tech_action.pkl",
...
def train_google():
    mlp_training = TrainingUsingMLP("5_processed_with_actions/GOOG_5day_tech_action.csv", "Google")
    mlp_training.run("5_processed_with_actions/GOOG_5day_tech_action.pkl",
...
def train_apple():
    mlp_training = TrainingUsingMLP("5_processed_with_actions/AAPL_5day_tech_action.csv", "Apple")
    mlp_training.run("5_processed_with_actions/AAPL_5day_tech_action.pkl",
...
def train_nvidia():
    mlp_training = TrainingUsingMLP("5_processed_with_actions/NVDA_5day_tech_action.csv", "NVIDIA")
    mlp_training.run("5_processed_with_actions/NVDA_5day_tech_action.pkl",
                     hidden_layers=(200, 200, 200,),
                     max_iter=1000,
                     alpha=0.001,
                     learning_rate_init=0.0001,
...
def train_amazon():
    mlp_training = TrainingUsingMLP("5_processed_with_actions/AMZN_5day_tech_action.csv", "Amazon")
    mlp_training.run("5_processed_with_actions/AMZN_5day_tech_action.pkl",
                     hidden_layers=(100, 100, 100,),
                     max_iter=700,
                     alpha=0.001,
                     learning_rate_init=0.0001,
