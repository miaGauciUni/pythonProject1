...
def train_microsoft():
    ...
    mlp_training.run("5_processed_with_actions/MSFT_5day_tech_action.pkl", "6_stock_models/MSFT_MLP_model.pkl",
...
def train_google():
    ...
    mlp_training.run("5_processed_with_actions/GOOG_5day_tech_action.pkl", "6_stock_models/GOOG_MLP_model.pkl",
                     hidden_layers=(200, 200, 200),
                     max_iter=700,
                     alpha=0.00001,
                     learning_rate_init=0.0001,
...
def train_apple():
    ...
    mlp_training.run("5_processed_with_actions/AAPL_5day_tech_action.pkl", "6_stock_models/AAPL_MLP_model.pkl",
...
def train_nvidia():
    ...
    mlp_training.run("5_processed_with_actions/NVDA_5day_tech_action.pkl", "6_stock_models/NVDA_MLP_model.pkl",
                     hidden_layers=(200, 200, 200,),
                     max_iter=1000,
                     alpha=0.001,
                     learning_rate_init=0.0001,
