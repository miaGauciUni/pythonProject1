...
class ProcessingData:
    ...
    def calculate_price_differences(self):
        ...
        # Save the updated DataFrame with price differences
    ...
    def plot_histogram(self):
        ...
        # AAPL - 0.55, 0.8
        # AMZN
        quantile1 = np.quantile(price_differences[price_differences > 0], 0.4)
        quantile2 = np.quantile(price_differences[price_differences > 0], 0.6)
        ...
        plt.title('Histogram of Daily Closing Price Differences for AMZN Stock')
    ...
    def evaluate_last_10_days(self):
        ...
        for i in range(10, len(self.df)):
            ...
            Closings = self.df['Closing'].iloc[i - 10:i].values
            sma_5 = self.df['SMA_5'].iloc[i - 10:i].values
            sma_10 = self.df['SMA_10'].iloc[i - 10:i].values
            ema_5 = self.df['EMA_5'].iloc[i - 10:i].values
            ema_10 = self.df['EMA_10'].iloc[i - 10:i].values
            rsi = self.df['RSI'].iloc[i - 10:i].values
            macd = self.df['MACD'].iloc[i - 10:i].values
            signal_line = self.df['Signal_Line'].iloc[i - 10:i].values
            bb_upper = self.df['BB_upper'].iloc[i - 10:i].values
            bb_lower = self.df['BB_lower'].iloc[i - 10:i].values
        ...
        actions_df = pd.DataFrame(actions, columns=[
            ...
            'SMA_5_10', 'SMA_5_9', 'SMA_5_8', 'SMA_5_7', 'SMA_5_6',
            'SMA_5_5', 'SMA_5_4', 'SMA_5_3', 'SMA_5_2', 'SMA_5_1',
            'SMA_10_10', 'SMA_10_9', 'SMA_10_8', 'SMA_10_7', 'SMA_10_6',
            ...
            'EMA_10_10', 'EMA_10_9', 'EMA_10_8', 'EMA_10_7', 'EMA_10_6',
            ...
            'Signal_Line_10', 'Signal_Line_9', 'Signal_Line_8', 'Signal_Line_7', 'Signal_Line_6',
        ...
        actions_df.to_csv("5_processed_with_actions/NVDA_10day_tech_action.csv", index=False)
        print("Actions with technical indicators saved to NVDA_10day_tech_action.csv.")
...
if __name__ == '__main__':
    ...
    processing = ProcessingData("4_data_w_indicators/NVDA_tech_ind.csv")
