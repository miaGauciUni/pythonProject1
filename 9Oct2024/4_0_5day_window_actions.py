...
class ProcessingData:
    ...
    def evaluate_last_5_days(self):
        ...
        actions_df.to_csv("5_processed_with_actions/MSFT_5day_tech_action.csv", index=False)
        print("Actions with technical indicators saved to MSFT_5day_tech_action.csv.")
